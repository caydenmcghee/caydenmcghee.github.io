    ...
    var levelData = [
      ...
      },
      {
        ...
        gameItems: [
          ...
          { type: "enemy", x: 700, y: groundY - 50, damage: 10, score: 100, hzSize: 25, image: "img/knight.png", offsetX: -50, offsetY: -80, scaleX: 0.25, scaleY: 0.25, speed: 2 },
          { type: "enemy", x: 1200, y: groundY - 50, damage: 15, score: 100, hzSize: 25, image: "img/jester.png", offsetX: -60, offsetY: -55, scaleX: 0.15, scaleY: 0.15, speed: 2 },
          { type: "enemy", x: 1700, y: groundY - 50, damage: 15, score: 100, hzSize: 25, image: "img/jester.png", offsetX: -60, offsetY: -55, scaleX: 0.15, scaleY: 0.15, speed: 2 },
          { type: "enemy", x: 2100, y: groundY - 50, damage: 10, score: 100, hzSize: 25, image: "img/knight.png", offsetX: -50, offsetY: -80, scaleX: 0.25, scaleY: 0.25, speed: 2 },
          { type: "enemy", x: 2300, y: groundY - 50, damage: 15, score: 100, hzSize: 25, image: "img/jester.png", offsetX: -60, offsetY: -55, scaleX: 0.15, scaleY: 0.15, speed: 2 },
          { type: "enemy", x: 2600, y: groundY - 50, damage: 999, score: 100, hzSize: 25, image: "img/king.png", offsetX: -140, offsetY: -190, scaleX: 1.2, scaleY: 1.2, speed: 2 },
          { type: "reward", x: 1000, y: groundY - 90, hzSize: 25, image: "img/gems.png", offsetX: -50, offsetY: -45, scaleX: 0.4, scaleY: 0.35, score: 200, health: 5 },
          { type: "reward", x: 1400, y: groundY - 90, hzSize: 25, image: "img/gems.png", offsetX: -50, offsetY: -45, scaleX: 0.4, scaleY: 0.35, score: 200, health: 5 },
          { type: "reward", x: 1800, y: groundY - 90, hzSize: 25, image: "img/gems.png", offsetX: -50, offsetY: -45, scaleX: 0.4, scaleY: 0.35, score: 200, health: 5 },
        ],
      },
    ];
